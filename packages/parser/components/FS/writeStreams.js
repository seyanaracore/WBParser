import { DEFAULT_OUT_PATH, DEFAULT_TYPE_OUT_FILES } from '../../utils/constants.js'
...
export const getErrorWriter = sellerName =>
  new writeCSVStream(
    join(
      DEFAULT_OUT_PATH,
      '_errors',
      sellerName + '_' + getDateAndTime() + '_errors.' + DEFAULT_TYPE_OUT_FILES
    ),
    errorsHeaders
  )
...
export const getLinksWriter = sellerName =>
  new writeCSVStream(
    join(
      DEFAULT_OUT_PATH,
      '_links',
      sellerName + '_' + getDateAndTime() + '_links.' + DEFAULT_TYPE_OUT_FILES
    ),
    linksHeaders
  )
